      ...
      <div className="container mx-auto px-4 md:px-6 z-10 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-block mb-6 px-3 py-1 rounded-full bg-secondary text-primary text-sm font-medium">
            <AnimatedText 
              text="Award-winning design studio" 
              tag="span"
              animation="fade"
              delay={300}
            />
          ...
          <AnimatedText
            text="We craft beautiful digital experiences that elevate brands"
            tag="h1"
          ...
          <AnimatedText
            text="Our team of designers and developers create stunning websites, apps, and digital products that drive results."
            tag="p"
