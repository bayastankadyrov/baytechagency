...
const Portfolio = ({
  ...
  return <section id="portfolio" className="section-container py-20 bg-slate-50/50 dark:bg-slate-900/30 rounded-none px-0">
      <div className="text-center mb-16">
        <AnimatedText text={t.heading} tag="h2" className="section-heading mb-4 text-3xl md:text-4xl lg:text-5xl font-display font-bold tracking-tight" animation="slide-up" />
